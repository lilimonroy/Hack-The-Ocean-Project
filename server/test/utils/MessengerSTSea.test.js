...
describe('Pruebas de unidad de la clase MessengerSTSea',()=>{
    ...
    test('1) Enumerar las opciones en mensaje',()=>{
        ...
        expect(jointedMessage).toBe("1) Inserte 1 para continuar su denuncia desde nuetro sitio oficial. | 2) Inserte 2 para continuar su denuncia aquí mismo en Telegram.")
    })
